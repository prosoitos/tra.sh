...
- empty the trash based on cutoff date, pattern, etc. or fully empty it
...
Multiple files can be selected with the <tab> key in the [[https://github.com/junegunn/fzf][fzf]] list to be restored at once.
