...
|---------+---------------------------+----------------------+--------------------------------------------------------------|
| ts      | "trash send"              | send to trash        |                                                              |
|---------+---------------------------+----------------------+--------------------------------------------------------------|
| tls     | "trash list"              | list trash content   | entire trash from current mountpoint                         |
...
|---------+---------------------------+----------------------+--------------------------------------------------------------|
| trs     | "trash restore"           | restore from trash   | entire trash from current mountpoint                         |
...
|---------+---------------------------+----------------------+--------------------------------------------------------------|
| trm     | "trash remove"            | remove from trash    | entire trash from current mountpoint                         |
| trd     | "trash remove directory"  | (permanently delete) | only files/dirs trashed from current directory               |
...
|---------+---------------------------+----------------------+--------------------------------------------------------------|
| tcl     | "trash clean"             | empty trash          | entire trash from current mountpoint (others untouched)      |
| tcd <n> | "trash clean date"        | (permanently delete) | same, for files/dirs trashed up to (including) <n> days      |
